...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def __init__(self, config: T5Config):
        ...
        self.last_dim_linear = nn.Linear(2048, 768) # ResNext
        # self.last_dim_linear = nn.Linear(512, 768) # Clip
        
        self.m_attn = MultiHeadAttention(768,8) # MultiheadAttention(embed_dim, num_heads)
